...
def main():
    ...
    argparser.add_argument("--scene_root",type=str,default="/cluster/home/cymoser/data/GaussianWorld/scannetpp_v2_mcmc_3dgs_preprocessed")
    argparser.add_argument("--metadata_root",type=str,default="/cluster/home/cymoser/projects/SceneSplat_Benchmark/gaussian_world_3d_semseg_benchmarks/embeddings")
...
def build_model(k:int,model_typ="medium",device="cpu",class_subset=100)->dict:
    ...
    label_map_file = os.path.join("/cluster/home/cymoser/projects/SceneSplat/pointcept/datasets/preprocessing/scannetpp/metadata/semantic_benchmark","top100.txt")
